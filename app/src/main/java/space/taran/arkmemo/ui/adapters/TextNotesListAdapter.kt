...
import space.taran.arkmemo.ui.fragments.VersionsFragment

class TextNotesListAdapter : RecyclerView.Adapter<TextNotesListAdapter.NoteViewHolder>() {
    ...
    inner class NoteViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val clickNoteToVersionsListener = View.OnClickListener {
            val selectedVersion = versions!![bindingAdapterPosition]
            activity?.fragment = VersionsFragment.newInstance(selectedVersion)
        ...
        init {
            ...
            binding.versionsNote.setOnClickListener(clickNoteToVersionsListener)
        }
